...
public final class Constants {
    ...
    // Geofence parameters for the Android building on Google's main B-17 sec_60 Noida UP..
    public static final String ANDROID_BUILDING_ID = "1";
    public static final double ANDROID_BUILDING_LATITUDE = 28.6017460;
    public static final double ANDROID_BUILDING_LONGITUDE = 77.3631090;
    ...
    public static final double YERBA_BUENA_LATITUDE = 28.700390;
    public static final double YERBA_BUENA_LONGITUDE = 77.117375;
    public static final float YERBA_BUENA_RADIUS_METERS = 72.0f;

    // Geofence parameters for the Yerba Buena Gardens near the Moscone Center in San Francisco.
    public static final String OFFICE_ID = "3";
    public static final double OFFICE_LATITUDE = 28.601839;
    public static final double OFFICE_LONGITUDE = 77.363148;
    public static final float OFFICE_RADIUS_METERS = 72.0f;
