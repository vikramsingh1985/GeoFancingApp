...
import static com.example.android.wearable.geofencing.Constants.OFFICE_ID;
import static com.example.android.wearable.geofencing.Constants.OFFICE_LATITUDE;
import static com.example.android.wearable.geofencing.Constants.OFFICE_LONGITUDE;
import static com.example.android.wearable.geofencing.Constants.OFFICE_RADIUS_METERS;
...
public class MainActivity extends Activity implements ConnectionCallbacks,
    ...
    public void createGeofences() {
        ...
        mOfficeGeofence = new SimpleGeofence(
                OFFICE_ID,                // geofenceId.
                OFFICE_LATITUDE,
                OFFICE_LONGITUDE,
        ...
        mGeofenceStorage.setGeofence(OFFICE_ID, mOfficeGeofence);
        mGeofenceList.add(mAndroidBuildingGeofence.toGeofence());
        mGeofenceList.add(mYerbaBuenaGeofence.toGeofence());
        mGeofenceList.add(mOfficeGeofence.toGeofence());
    }
